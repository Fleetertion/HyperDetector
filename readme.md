...
- The Clearscope raw files are already organized under `data/clearscope/benign/` and `data/clearscope/attack/`.
- The processed graph caches have already been generated by `utils/clearscope_parser.py`, so training and evaluation can use the dataset directly.
